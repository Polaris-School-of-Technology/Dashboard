      ...
      <div className="notifications-card">
        ...
        <div className="notifications-form-container">
          <form onSubmit={handleSubmit} className="notifications-form">
            ...
            <div className="notification-type-selector">
              {['batch', 'global', 'parents', 'users'].map((t) => (
                <label
                  ...
                  onClick={() => handleTypeChange(t as NotificationType)}
                >
                  <input
                    type="radio"
                    name="type"
                    value={t}
                    checked={type === t}
                    onChange={() => handleTypeChange(t as NotificationType)}
                  />
            ...
            {/* Batch Dropdown */}
            {type === 'batch' && (
              <div className="form-group full batch-id-group fade-in">
            ...
            <div className="form-grid">
              <div className="form-group full">
                ...
                <input
                  ...
                  maxLength={30}
                />
                <span className="field-hint">{title.length}/30</span>
              </div>
              ...
              <div className="form-group half">
                ...
                <div className="checkbox-group">
                  ...
                  />
                  <label className="checkbox-label" htmlFor="isHeader">
                    Show as header notification
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="form-group full">
              ...
              {imageFile && (
                <div className="uploaded-file-info image-info fade-in">
            ...
            {/* Users Section */}
            {type === 'users' && (
              <div className="users-specific fade-in">
                <div className="form-group full">
                ...
                <div className="form-group full">
                  ...
                  {csvFile && (
                    <div className="uploaded-file-info fade-in">
                      <div className="file-details">
            ...
            {response.message && (
              <div className={`response-area ${response.type} fade-in`}>{response.message}</div>
            )}
          </form>
        </div>
      </div>
