...
exports.getStudentResponses = exports.sessionQuestions = exports.getSessionsByDate = void 0;
...
const getStudentResponses = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { data, error } = yield supabase_1.supabase.rpc("get_all_student_responses_for_a_session", {
