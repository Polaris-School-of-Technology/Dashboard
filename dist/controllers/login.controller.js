...
exports.changePassword = exports.resetPassword = exports.forgotPassword = exports.logout = exports.login = void 0;
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ id: user.id, role: user.role, facultyId: user.faculty_id }, process.env.JWT_SECRET, { expiresIn: "30d" });
        return res.json({
...
const forgotPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        yield sendEmail(email, "Password Reset Request", emailHtml);
        return res.json({
            message: "If the email exists, a password reset link has been sent",
        });
    }
...
const resetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        yield sendEmail(user.email, "Password Reset Successful", emailHtml);
...
const changePassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { data: users, error } = yield supabase
            ...
            .eq("id", userId)
            .limit(1);
        if (error || !(users === null || users === void 0 ? void 0 : users[0])) {
            return res.status(404).json({ message: "User not found" });
        }
        const user = users[0];
        // Verify current password
        const validPassword = yield bcryptjs_1.default.compare(currentPassword, user.password_hash);
        if (!validPassword) {
    ...
    `;
        yield sendEmail(user.email, "Password Changed - Security Alert", emailHtml);
