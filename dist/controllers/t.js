...
exports.updateApplicationStatus = exports.getJobApplications = exports.getJobById = exports.getAllJobsAdmin = exports.createJob = void 0;
    ...
    try {
        ...
        if (requiredSkills.length > 0) {
            const { error: skillsError } = yield supabase_1.supabase
                ...
                .insert(requiredSkills.map((skill) => ({
                job_id: jobId,
                skill_name: skill
            })));
            if (skillsError)
    ...
    try {
        ...
        const transformedJobs = data.map((job) => {
            ...
            return ({
                ...
                batch: ((_b = job.batches) === null || _b === void 0 ? void 0 : _b.year) || 'N/A',
